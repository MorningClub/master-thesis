...
def parse_results(path):
    ...
    #with open('/lhome/asszewcz/Documents/WorldOnRails/config_nocrash_town01_testweather_100k'+'.csv', 'r') as file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('config', default="/lhome/asszewcz/Documents/WorldOnRails/config_nocrash_town01_testweather_100k")
