...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        #print("encode shape1: ", x.shape)
        x = self.conv1(x)
        #print("encode shape2: ", x.shape)
        x = self.bn1(x)
        #print("encode shape3: ", x.shape)
        x = self.relu(x)
        #print("encode shape4: ", x.shape)
        x = self.maxpool(x)
        #print("encode shape5: ", x.shape)

        x = self.layer1(x)
        #print("encode shape6: ", x.shape)
        x = self.layer2(x)
        #print("encode shape7: ", x.shape)
        x = self.layer3(x)
        #print("encode shape8: ", x.shape)
        x = self.layer4(x)
        #print("encode final shape: ", x.shape)
